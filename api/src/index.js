...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DeleteResponse', 'model/EditResponse', 'model/Key', 'model/User', 'api/KeysApi', 'api/UserApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/DeleteResponse'), require('./model/EditResponse'), require('./model/Key'), require('./model/User'), require('./api/KeysApi'), require('./api/UserApi'));
  }
}(function(ApiClient, DeleteResponse, EditResponse, Key, User, KeysApi, UserApi) {
  'use strict';
