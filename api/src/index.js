...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DeleteResponse', 'model/EditResponse', 'model/FullKey', 'model/Key', 'model/LightUser', 'model/User', 'api/KeysApi', 'api/UserApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/DeleteResponse'), require('./model/EditResponse'), require('./model/FullKey'), require('./model/Key'), require('./model/LightUser'), require('./model/User'), require('./api/KeysApi'), require('./api/UserApi'));
  }
}(function(ApiClient, DeleteResponse, EditResponse, FullKey, Key, LightUser, User, KeysApi, UserApi) {
  'use strict';
